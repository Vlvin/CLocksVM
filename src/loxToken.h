...
typedef struct LoxValue LoxValue;
...
typedef enum TokenType {
  ...
  TOKEN_RIGHT_PAREN,
  TOKEN_LEFT_BRACE,
  TOKEN_RIGHT_BRACE, // Single-character tokens.
  TOKEN_COMMA,
  TOKEN_DOT,
  TOKEN_MINUS,
  TOKEN_PLUS,
  TOKEN_SEMICOLON,
  TOKEN_SLASH,
  TOKEN_STAR, // Single-character tokens.
  ...
  TOKEN_EQUAL,
  TOKEN_EQUAL_EQUAL, // One or two character tokens.
  TOKEN_GREATER,
  TOKEN_GREATER_EQUAL, // One or two character tokens.
  TOKEN_LESS,
  TOKEN_LESS_EQUAL, // One or two character tokens.

  // Literals.
  TOKEN_IDENTIFIER,
  TOKEN_STRING,
  TOKEN_NUMBER, // Literals.
